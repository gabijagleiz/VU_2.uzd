...
//vidurkis
double vidurkis(deque <int> nd, int nkiek, int egz){
    double vv;
    int sum = 0;
...
//mediana
double mediana (deque <int> nd, int nkiek, int egz){
	double median;
	int d = 0;
    	for (int j = 0; j < nkiek; j++){
    	d = nkiek;
...
void Vivedimas(deque <Studentas> &S, deque <Studentas> &protingi, deque <Studentas> &nevykeliai){
		int k = 0;
	double sum = 0;
	int r;
...
void Vskaitymas(deque <Studentas> &S, deque <Studentas> &protingi, deque <Studentas> &nevykeliai){
...
void Vgenskaitymas(deque <Studentas> &S, deque <Studentas> &protingi, deque <Studentas> &nevykeliai){
